...
parameter_types! {
  pub const LaunchPeriod: BlockNumber = 40 * MINUTES;
  pub const VotingPeriod: BlockNumber = 40 * MINUTES;
  pub const FastTrackVotingPeriod: BlockNumber = 6 * MINUTES;
  pub const MinimumDeposit: Balance = 100 * DOLLARS;
  pub const EnactmentPeriod: BlockNumber = 46 * MINUTES;
  pub const CooloffPeriod: BlockNumber = 40 * MINUTES;
  // One cent: $10,000 / MB
...
parameter_types! {
  ...
  pub RentFraction: Perbill = Perbill::from_rational_approximation(1u32, 180 * MINUTES);
