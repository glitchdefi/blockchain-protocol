				...
				.priority(
					{
						...
						// These formulars reduce the priority 1000 times. The default formulars don't have the '/1000' part.
						if is_lower_priority {
							(gas_price_priority / 2) / 1000 - weight_from_gas_limit
						} else {
							gas_price_priority / 1000 - weight_from_gas_limit
						}
					}
				);
