...
use glitch_node_runtime::{self, opaque::Block, RuntimeApi};
...
native_executor_instance!(
  pub Executor,
  glitch_node_runtime::api::dispatch,
  glitch_node_runtime::native_version,
);
    ...
    let sc_service::PartialComponents {
        ...
        other:
            (
                ...
                import_setup,
                (rpc_setup, pending_transactions, filter_pool, frontier_backend),
            ),
